...
- App ID: `com.richardlesh.bengalcalc`
- Artifact naming: `BengalCalc-{version}-{arch}.{ext}`
...
## Persisted Data
- Settings file: `~/.bengalcalc-settings.json` (written by main process via `fs` module)
